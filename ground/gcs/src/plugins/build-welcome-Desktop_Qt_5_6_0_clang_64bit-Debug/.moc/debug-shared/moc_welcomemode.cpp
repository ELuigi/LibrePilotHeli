...
void Welcome::WelcomeMode::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        WelcomeMode *_t = static_cast<WelcomeMode *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (WelcomeMode::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WelcomeMode::newVersionTextChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Welcome::WelcomeMode::staticMetaObject = {
    { &Core::IMode::staticMetaObject, qt_meta_stringdata_Welcome__WelcomeMode.data,
      qt_meta_data_Welcome__WelcomeMode,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Welcome::WelcomeMode::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Welcome__WelcomeMode.stringdata0))
        return static_cast<void*>(const_cast< WelcomeMode*>(this));
