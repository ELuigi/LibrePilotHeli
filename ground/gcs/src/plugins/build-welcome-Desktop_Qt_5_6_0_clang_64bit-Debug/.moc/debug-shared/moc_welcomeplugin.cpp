...
#include "../../../welcome/welcomeplugin.h"
...
const QMetaObject Welcome::Internal::WelcomePlugin::staticMetaObject = {
    { &ExtensionSystem::IPlugin::staticMetaObject, qt_meta_stringdata_Welcome__Internal__WelcomePlugin.data,
      qt_meta_data_Welcome__Internal__WelcomePlugin,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Welcome::Internal::WelcomePlugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Welcome__Internal__WelcomePlugin.stringdata0))
        return static_cast<void*>(const_cast< WelcomePlugin*>(this));
...
static const unsigned char qt_pluginMetaData[] = {
    ...
    0x11, 0x00, 'O',  'p',  'e',  'n',  'P',  'i', 
    'l',  'o',  't',  '.',  'W',  'e',  'l',  'c', 
    'o',  'm',  'e',  0x00, 0x9b, 0x07, 0x00, 0x00,
    0x09, 0x00, 'c',  'l',  'a',  's',  's',  'N', 
    'a',  'm',  'e',  0x00, 0x0d, 0x00, 'W',  'e', 
    'l',  'c',  'o',  'm',  'e',  'P',  'l',  'u', 
    'g',  'i',  'n',  0x00, 0x1a, 0xc0, 0xa0, 0x00,
...
static const unsigned char qt_pluginMetaData[] = {
    ...
    0x11, 0x00, 'O',  'p',  'e',  'n',  'P',  'i', 
    'l',  'o',  't',  '.',  'W',  'e',  'l',  'c', 
    'o',  'm',  'e',  0x00, 0x95, 0x07, 0x00, 0x00,
    0x08, 0x00, 'M',  'e',  't',  'a',  'D',  'a', 
    't',  'a',  0x00, 0x00, 0x0c, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x1b, 0x0b, 0x00, 0x00, 0x09, 0x00, 'c',  'l', 
    'a',  's',  's',  'N',  'a',  'm',  'e',  0x00,
    0x0d, 0x00, 'W',  'e',  'l',  'c',  'o',  'm', 
    'e',  'P',  'l',  'u',  'g',  'i',  'n',  0x00,
